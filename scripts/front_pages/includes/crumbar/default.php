...
if ($this->conf['crumbar_tmpl_path'])  	$template = $this->cObj->fileResource($this->conf['crumbar_tmpl_path']);
elseif ($this->conf['crumbar_tmpl'])  	$template = $this->cObj->fileResource($this->conf['crumbar_tmpl']);
else												$template = $this->cObj->fileResource(t3lib_extMgm::siteRelPath($this->extKey).'templates/crumbar.tmpl');
